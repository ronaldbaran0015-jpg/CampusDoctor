...
<div class="content-wrapper">
    <div class="schedule-section container-fluid">
        <article class="d-flex align-items-center  justify-content-between gap-5 mb-4">
            <h4 class="top-heading mb-0">Dr. {{$doctor->name}}</h4>
                        ...
                        <tr class="text-start">
                            ...
                            <td style="background-color: var(--outgoing-bg); color:var(--txt-color);" class="text-center">
                                <div class="d-flex align-items-center justify-content-center gap-2">
                                    ...
                                    <form action="{{route('schedule.delete', $sched->scheduleid)}}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-danger p-2"><i class="fa fa-trash" onclick="return confirm('Do you want to delete this schedule for doctor: {{ $sched->mydoctor->name }}')"></i></button>
                                    </form>
                                </div>
                            </td>
                        </tr>
